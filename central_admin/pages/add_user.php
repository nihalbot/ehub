...
echo '<title>Create User - Central Admin</title>';
...
<div class="container-fluid main-content flex-grow-1 pt-3 ps-3 tabel-cotainer">
    ...
    <div class="row form-container">
        <div class="col col-lg-12 col-md-12 form-section">
            ...
            <!-- main form start -->
            <form action="./add_user_process.php" class="row g-3" method="post">
                ...
                <div class="col-12 btn-add mt-1 mt-lg-4 mt-md-4">
                    <button type="submit" class="btn btn-primary" name="add_admin">Create User</button>
                </div>
