...
<head>
    ...
    <title>E-Hub - A autometed system for disater</title>
    <link rel="icon" href="./central_admin/assets/img/site_logo.jpg">
                        ...
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="./shelter_coordinator/pages/signin.php">Shelter Coordinator</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
